...
// calls the element <input>
var tempF = document.querySelector('.temp-f');
// calls the element <input> for celular temp
var tempC = document.querySelector('.temp-c');

// Eventlisteners tells us which event we want to listen to, which is keyup
tempF.addEventListener('keyup', calcFtoC);
tempC.addEventListener('keyup', calcCtoF);

function calcFtoC(event) {
  if (tempF.value.length > 0) {
//whatever the function on the right returns gets saved as tempC value
